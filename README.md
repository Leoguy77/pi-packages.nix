...
**8,320 packages** — see [`registry/registry.json`](./registry/registry.json) for the full list.
...
| Tier A (zero deps, direct unpack) | 5,521 |
| Tier B (has npm deps) | 2,799 |
| With lockfile (`buildNpmPackage`, cached) | 2,707 |
